...
let actualizarUsuario = () => {
    ...
    axios.put(`http://localhost:3000/api/v1/usuarios/${usuarioActualizar}`,info,{headers:{"token":token}}).then(respuesta => {
        ...
        mensaje.innerHTML = data
        document.getElementById("txtDocumento").style.display = "inline"
        document.getElementById("txtContraseña").style.display = "inline"
...
let cargarDatosUsuario = index => {
    ...
    document.getElementById("cmbTipoDocumento").value =  usuario.tipo_documento
    document.getElementById("txtDocumento").style.display = "none"
    ...
    document.getElementById("cmbRoles").value =  usuario.rol
